        ...
        <div class="py-6 mx-auto max-w-[1290px] px-[15px]">
            <div class="grid grid-cols-2 gap-8 lg:grid-cols-6 mb-[48px]">
                ...
                <div class="col-span-2">
                    ...
                    <p class="my-4 font-light text-base font-normal text-gray-500 dark:text-gray-400 "> <span class="text-base font-normal text-black dark:text-gray-400">Autoplatfroma.сom</span>  - your trusted guide in the world of automobiles. Our <span class="text-base font-normal text-black dark:text-gray-400">experts</span> make your choice safe and easy. Start
                        your journey <span class="text-base font-normal text-black dark:text-gray-400">with us</span>  today and give life a <span class="text-base font-normal text-black dark:text-gray-400">new inspiration</span>  on wheels</p>
                    <!-- блок иконок -->
                ...
                <div class="lg:mx-auto">
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white ">Popular makes</h2>
                    <ul class="text-gray-500 dark:text-gray-400 ">
                        <li class="mb-4">
