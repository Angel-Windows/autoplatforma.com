...
{{--                {{$item_card->body->name}}--}}
        ...
        <div class="flex gap-x-1.5 mb-1">
            <p class="leading-tight text-xl font-semibold text-gray-900 dark:text-gray-400 ">${{$item_card->price_bid}}</p>
            <!-- gray block -->
        ...
        <p class="leading-tight text-xs font-medium text-gray-500 mb-1 ">Primary Damage: {{$item_card->damage->name}}</p>
