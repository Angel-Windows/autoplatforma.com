            ...
            <section class=" bg-white dark:bg-gray-900">
                <div class="mx-auto max-w-[1290px] px-[15px]">
                    <div class=" pt-[28px] mx-auto max-w-screen-xl text-center pb-[25px] ">
                        <h1 class="text-center leading-tight text-3xl md:text-4xl font-extrabold mb-[5px] dark:text-white ">KIA K5 2016 from Copart Auto Auction</h1>
                        <p class="text-center  text-base md:text-lg max-w-[450px] mx-auto font-normal text-gray-500 mb-[41px] "> KNAL2182DJ2818J1</p>
                        <div class=" block md1:flex  justify-between  gap-[10px]   ">
                            ...
                            <div id="gallery" class="gallery absolute top-0 left-0 z-20 min-h-[100vh]" style="display: none;">
                                <!-- btn -->
                                <button id="btn-close" type="button" class="fixed top-5 right-5">
                                    <img src="img/auto/btn-close.svg" alt="picture">
                                </button>
                                <div>
                                    <img src="img/auto/01.webp" alt="picture" class="border-[3px] border-white border-l-[6px] border-r-[6px]">
                                </div>
                                <div>
                                    <img src="img/auto/02.webp" alt="picture" class="border-[3px] border-white border-l-[6px] border-r-[6px]">
                                </div>
                                <div>
                                    <img src="img/auto/03.webp" alt="picture" class="border-[3px] border-white border-l-[6px] border-r-[6px]">
                                </div>
                                <div>
                                    <img src="img/auto/04.webp" alt="picture" class="border-[3px] border-white border-l-[6px] border-r-[6px]">
                                </div>
                                <div>
                                    <img src="img/auto/05.webp" alt="picture" class="border-[3px] border-white border-l-[6px] border-r-[6px]">
                                </div>
                                <div>
                                    <img src="img/auto/01.webp" alt="picture" class="border-[3px] border-white border-l-[6px] border-r-[6px]">
                                </div>
                            ...
                            <!-- right block -->
                            <div class="rounded-lg bg-white md:shadow-md md:px-[23px] py-5 items-start dark:bg-gray-800">
                                ...
                                <div class="flex items-center justify-between mb-[14px]">
                                                <span
                                                    ...
                                                    11 Sep, 2023 / 16:00 CET
                                                </span>
                                    <div class=" ">
                                        <img src="img/auto/logo/copart_logo.svg" alt="logo-copart" class="w-full ">
                                    </div>
                                </div>
                                ...
                                <ul
                                    ...
                                    <li class=" mx-4  flex justify-between items-center">
                                        <div>Condition: <span class="text-sm font-normal text-gray-500">Run & Drive Verified</span></div>
                                        <span
                                            class="bg-gray-100 text-gray-800 text-xs font-medium gap-1 inline-flex items-center px-2.5 py-0.5 rounded-md  dark:bg-gray-700 dark:text-gray-400 ">
                                                        <svg xmlns="http://www.w3.org/2000/svg" data-name="icon" width="14" height="14" viewBox="0 0 14 14"
                                    ...
                                    <li class=" mx-4 flex justify-between items-center">
                                        <div> Mileage: <span class="text-sm font-normal text-gray-500">120 428 km</span></div>
                                        <span
                                            class="bg-gray-100 text-gray-800 text-xs font-medium gap-1 inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-gray-400 ">
                                    ...
                                    <div class="border-b border-gray-300 h-[1px] w-[100%]"></div>
                                    <li class=" mx-4 flex justify-between items-center">
                                        <div>Primary Damage: <span class="text-sm font-normal text-gray-500">FRONT END</span></div>


                                    </li>
                                    <div class="border-b border-gray-300 h-[1px] w-[100%]"></div>
                                    <li class="mx-4 flex justify-between items-center">
                                        <div>Secondary Damage: <span class="text-sm font-normal text-gray-500">REAR END</span></div>
                                    </li>
                                </ul>

                                <p class="text-sm font-semibold text-gray-900 mb-[14px] dark:text-white">Specify the maximum final cost for the car that you
                                    are willing to pay.</p>

                                <div class="flex justify-between  items-center mb-[14px] rounded-md border border-gray-300 bg-primary-100 p-[10px] dark:bg-gray-600">
                                    <button type="button"
                                    ...
                                    <button type="button"
                                        ...
                                        Decrease</button>
                                    <div class="relative w-[100%] lg:w-[90%] lg1:w-[90%] lg2:w-[80%] xl:w-[70%] h-[36px]">
                                        <form action="#" class="flex items-center">
                                            <div class="flex flex-auto">
                                                ...
                                                <input type="search" id="default-search-1"
                                                       ...
                                                       placeholder="" required="" value="20.000">
                                            </div>
                                ...
                                <div>
                                    ...
                                    <div id="alert-3"
                                        ...
                                        <div
                                            ...
                                            <svg class="flex-shrink-0 w-[18px] h-[18px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <p class="px-0 md1:px-0 text-left text-sm font-normal text-green-800 mb-3">
                                            If you're not an experienced car buyer, we recommend reaching out to our team of specialists. They will inspect the
                                            vehicle, provide their insights, and assist you in selecting the perfect car for your needs


                                        </p>

                                        <!-- buttons  -->
                                        <div class="text-left px-0 md1:px-0 block lg2:flex items-center justify-between gap-3">
                                            <button type="button"
                        ...
                        <div class="block lg1:flex justify-between">
                            <div class="block md:flex w-[100%] mb-4 lg1:mb-0 lg1:w-[56%] border   rounded-lg">
                                <table class="w-full">
                                    ...
                                    <tr class="h-[37px] border-b border-gray-200 border-b border-gray-200">
                                        ...
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px] ">59766553</span>
                                        </td>

                                    </tr>
                                    <tr class="h-[37px] border-b border-gray-200">
                                        <td
                                            class="bg-gray-50  text-sm font-normal text-gray-900 w-[180px] text-left  pl-[10px] border-r border-gray-200 dark:text-white dark:bg-gray-800 ">
                                            VIN:</td>
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px] ">KNDJN2A26G7836673</span>
                                        </td>
                                    ...
                                    <tr class="h-[37px] border-b border-gray-200">
                                        ...
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">04.09.2023</span>
                                        </td>

                                    </tr>
                                    <tr class="h-[37px] border-b border-gray-200">
                                        <td
                                            class="bg-gray-50 text-sm font-normal text-gray-900 w-[180px] text-left  pl-[10px] border-r border-gray-200 dark:text-white dark:bg-gray-800 dark:text-white dark:bg-gray-800">
                                            Status:</td>
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">Upcoming</span>
                                        </td>
                                    ...
                                    <tr class="h-[37px] border-b border-gray-200">
                                        ...
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">Automatic</span>
                                        </td>
                                    ...
                                    <tr class="h-[37px] border-b border-gray-200">
                                        ...
                                        <td class=" w-[180px] text-center">
                                                                        <span
                                                                            class="bg-red-300 text-green-800 text-xs font-medium   rounded dark:bg-red-900 dark:text-red-300 w-[180px] px-[10px] py-[2px]">No</span>
                                        </td>

                                    </tr>
                                    <tr class="h-[37px] ">
                                        <td
                                            class="bg-gray-50  text-sm font-normal text-gray-900 w-[180px] text-left pl-[10px]  pl-[10px] border-r border-gray-200 rounded-bl-[0px] md:rounded-bl-[8px] dark:text-white dark:bg-gray-800">
                                            Color:</td>
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">Green</span>
                                        </td>
                                ...
                                <table class="w-full">
                                    ...
                                    <tbody>
                                    <tr class="h-[37px] border-b border-gray-200 border-t border-gray-200 md:border-t-0">
                                        <td
                                            class="bg-gray-50  text-sm font-normal text-gray-900 w-[173px] text-left  pl-[10px] border-r border-gray-200 dark:text-white dark:bg-gray-800 md:border-l border-gray-200">
                                            Drive:</td>
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800   rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">Front-wheel
                                                                            Drive</span>
                                        </td>
                                    ...
                                    <tr class="h-[37px] border-b border-gray-200">
                                        <td
                                            class="bg-gray-50 text-sm font-normal text-gray-900 w-[173px] text-left  pl-[10px] border-r border-gray-200 md:border-l border-gray-200 dark:text-white dark:bg-gray-800">
                                            Fuel:</td>
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800 rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">GAS</span>
                                        </td>
                                    ...
                                    <tr class="h-[37px] border-b border-gray-200">
                                        ...
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">On
                                                                            Minimum Bid</span>
                                        </td>
                                    ...
                                    <tr class="h-[37px] border-b border-gray-200">
                                        ...
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">SC-ST</span>
                                        </td>
                                    ...
                                    <tr class="h-[37px] border-b border-gray-200">
                                        ...
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">4</span>
                                        </td>
                                    ...
                                    <tr class="h-[37px] border-b border-gray-200">
                                        ...
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">F030</span>
                                        </td>

                                    </tr>
                                    <tr class="h-[37px] ">
                                        <td
                                            class="bg-gray-50 text-sm font-normal text-gray-900 w-[173px] text-left pl-[10px] rounded-bl-[8px] md:rounded-bl-[0px] border-r border-gray-200 md:border-l border-gray-200 dark:text-white dark:bg-gray-800">
                                            Retail price:</td>
                                        <td class="  w-[180px] text-center">
                                                                        <span
                                                                            class="bg-green-100 text-green-800 text-xs font-medium  text-green-800  rounded dark:bg-green-900 dark:text-green-300 w-[180px] px-[10px] py-[2px]">$10250</span>
                                        </td>
                            ...
                            <div class="block w-[100%] lg1:w-[43%]">
                                ...
                                <div class="flex gap-[14px] items-center mb-4 justify-between">
                                    <div class="w-[48%]">
                                        <div class="flex items-center rounded-[8px] bg-white  p-3 sm:p-5 gap-[14px] dark:bg-gray-800"
                                ...
                                <!-- select + final -->
                                <div class="block md:flex gap-[27px] rounded-[8px] justify-between bg-white  p-5 dark:bg-gray-800"
                                     style="box-shadow: 0px 2px 3px -1px rgba(0, 0, 0, 0.10), 0px 2px 4px 0px rgba(0, 0, 0, 0.10);">

                                    <!-- select -->
                                    <div class="w-[100%]">
                                        <div class="flex items-center gap-2 mb-[8px]">
                                            <p class="leading-tight text-sm font-medium text-gray-900 dark:text-white">Select delivery country</p>
                                            <div>
                                        ...
                                        <div class="mb-3 md:mb-0 relative">
                                            ...
                                            <div class="absolute top-[-4px] right-[17px]">
                                                                        <span class=" text-sm font-medium text-gray-900 dark:text-gray-300 ">Add delivery
                                                                            insurance</span>
                                                <p class="  text-xs font-normal text-gray-500 ">For the whole freight cycle</p>
                                            </div>
                                    ...
                                    <div class="w-[100%]">
                                        <div class="flex items-center gap-2 mb-[12px]">
                                            <p class="text-sm font-medium text-gray-900 dark:text-white">Final cost calculation</p>
                                            <div>
                                                <svg width="18" height="19" viewBox="0 0 18 19" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
                    ...
                    <div class="mx-auto max-w-screen-xl pb-10 px-[15px] clas-sect">
                        <div class="md:flex md:gap-[30px] md1:gap-[70px] lg1:gap-[128px]">
                            <div class="md:w-[53%] box-text">
                                <h2 class="text-lg font-medium text-black mb-[18px] dark:text-white">Overview of KNDJN2A26G7836673</h2>
                                <p class="text-lg font-normal text-gray-500 mb-[15px]">
                                    ...
                                    ingest data from
                                    other software development tools, so your IT support and operations teams have richer contextual
                                ...
                                <div class=" text-lg font-normal text-gray-500  box__post">
                                    <p>
                                        ...
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, ipsam pariatur iusto, deserunt
                                        voluptatibus quasi aliquid dolor obcaecati, rerum repellat iure totam natus dolore voluptatum fugiat
                                        reiciendis debitis quas libero.
                                    </p>
                                </div>
                                <div class="box__btn mt-[9px]">

                                    <button id="btn-more" class="leading-none text-sm font-medium text-primary-600 flex relative"
                                            type="button">Read more
                                        <svg class="w-2.5 h-2.5 ml-2.5 absolute top-[2px] left-[75px]" aria-hidden="true"
                                             xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                  d="m1 1 4 4 4-4" />
                                        </svg>
                                    </button>
                                    <button id="btn-show" class="leading-none text-sm font-medium text-primary-600 flex relative hidden"
                                            type="button">Show less
                                        <svg class="w-2.5 h-2.5 ml-2.5 absolute top-[2px] left-[75px]" aria-hidden="true"
                                             xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6" transform="rotate(180)">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                  d="m1 1 4 4 4-4" />
                                        </svg>
                                    </button>
                                ...
                                <div id="accordion-flush" data-accordion="collapse"
                                    ...
                                    <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
                                        <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                            <p class="mb-2 text-gray-500 dark:text-gray-400 ">Generally, it is accepted to use FlowBite in
                                                open-source projects, as long as it is not a UI library, a theme, a
                                                template, a page-builder that would be considered as an alternative to FlowBite itself.</p>
                                            <p class="mb-2 text-gray-500 dark:text-gray-400 ">With that being said, feel free to use this
                                                design kit for your open-source projects.</p>
                                            <p class="mb-2 text-gray-500 dark:text-gray-400 ">
                                                Find out more information by
                                                <a href="#" class="text-primary-600 dark:text-primary-500 hover:underline ">reading the
                                                    license.</a>
                                        </div>
                                    </div>
                                    <!-- 2 -->
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:px-4 ">
                            ...
                            <article
                                ...
                                <div class="p-5 pb-2.5">
                                    ...
                                    <p class="leading-tight text-xs font-medium text-gray-500 mb-1 ">Condition: Run & Drive Verified
                                    </p>
                                ...
                                <div class=" py-2 p-5 flex justify-between">
                                    ...
                                    <div class="flex gap-1">
                                        ...
                                        <p class="text-xs font-medium text-gray-900 dark:text-gray-300">Fuel: gasoline</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="inline-flex gap-1 bg-yellow-300 px-2 py-[5px] relative rounded-[3px]">
                                            ...
                                            <div class="absolute top-[23px] left-0">
                                                <svg class="text-yellow-300" xmlns="http://www.w3.org/2000/svg" id="Шар_2"
                                                     fill="currentColor" data-name="Шар 2" width="7" height="9.74"
                                                     viewBox="0 0 7 9.74">
                ...
                <div class="mx-auto max-w-[1290px] px-[15px]">
                    <div class="py-8  mx-auto max-w-screen-xl lg:py-16 ">
                        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                            <h2 class="mb-4 text-3xl md:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white ">Our Blog
                            </h2>
                            <p class="font-light text-gray-500 text-base md:text-xl dark:text-gray-400 ">Explore automotive auctions
